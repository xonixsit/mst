...
<body>
    <div class="header">
        ...
        <p>MySuperTax Messaging System</p>
    </div>
    
    <div class="content">
        <p>Hello {{ $recipient->first_name }},</p>
        
        <p>You have received a new message from a client in the MySuperTax system.</p>
        ...
        <p>Please log in to your admin dashboard to view the full conversation and respond to this message.</p>
        
        <a href="{{ config('app.url') }}/admin/messages/{{ $messageModel->id }}" class="button">
            View Message & Reply
        </a>
        
        <p><strong>Quick Actions:</strong></p>
        <ul>
            <li><a href="{{ config('app.url') }}/admin/messages">View All Messages</a></li>
            <li><a href="{{ config('app.url') }}/admin/clients/{{ $client->id }}">View Client Profile</a></li>
        </ul>
    </div>
    
    <div class="footer">
        <p>This is an automated notification from MySuperTax.<br>
