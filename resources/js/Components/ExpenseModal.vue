        ...
        <form @submit.prevent="handleSubmit" class="space-y-8">
          ...
          <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border border-blue-200">
            <div class="flex items-center mb-6">
              <div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center mr-3"></div>
              <svg ass="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <!-- Full Width Fields -->
        <div class="space-y-4">
          ...
          <div>
            ...
            <input id="particulars" v-model="formData.particulars" type="text" :class="inputClasses('particulars')"
          ...
          <div>
            ...
            <textarea id="remarks" v-model="formData.remarks" rows="3" :class="inputClasses('remarks')"
