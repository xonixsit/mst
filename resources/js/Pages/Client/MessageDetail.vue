      ...
      <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
          <div class="flex items-center justify-between">
            ...
            <div v-if="!message.is_read && message.recipient_id === $page.props.auth.user.id">
        ...
        <div v-if="message.read_at" class="px-6 py-3 bg-gray-50 border-t border-gray-200">
        ...
        <div class="mt-3">
          ...
          <form @submit.prevent="sendReply" class="space-y-4">
            <div>
              ...
              <input
                :value="message.sender_id === $page.props.auth.user.id ? message.recipient.name : message.sender.name"
                type="text"
