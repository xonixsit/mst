        ...
        <div class="relative flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-6 lg:space-y-0 py-2">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="mt-2 text-sm text-gray-600 font-medium">Describe your issue and we'll help you resolve it</p>
            </div>
          </div>
        ...
        <form @submit.prevent="submit" class="bg-white rounded-xl shadow-lg border border-gray-200 p-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white"
          ...
          <div>
            ...
            <textarea
              ...
              rows="6"
              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white resize-none"
          ...
          <div class="flex gap-3 pt-6 border-t border-gray-200">
            <button
              type="submit"
              :disabled="processing"
              class="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-semibold transform hover:scale-105"
            >
              {{ processing ? 'Creating...' : 'Create Ticket' }}
            </button>
            <Link href="/client/support-tickets" class="flex-1 px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded-lg transition-all duration-200 font-semibold text-center">
              Cancel
            </Link>
          </div>
        </form>
...
const submit = () => {
  form.post('/client/support-tickets')
}
</script>
