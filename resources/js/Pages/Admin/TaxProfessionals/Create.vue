<template>
  <AppLayout title="Add Tax Professional">
    <template #header>
        ...
        <div class="relative flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-6 lg:space-y-0 py-2">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="mt-2 text-sm text-gray-600 font-medium">Create a new tax professional account</p>
            </div>
          </div>
          ...
          <div class="bg-gradient-to-r from-slate-50 to-gray-50 px-8 py-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Enter the tax professional's details</p>
              </div>
          ...
          <form @submit.prevent="submit" class="p-8">
            <div class="space-y-8">
              ...
              <div class="bg-gradient-to-br from-red-50 to-rose-100 rounded-xl p-6 border border-red-200">
                <div class="flex items-center mb-6">
                  ...
                  <h4 class="text-lg font-bold text-red-900">Account Security</h4>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="space-y-2">
                    <label class="block text-sm font-semibold text-red-700">Password *</label>
                    <input
                  ...
                  <div class="space-y-2">
                    <label class="block text-sm font-semibold text-red-700">Confirm Password *</label>
                    <input
            ...
            <div class="flex justify-end gap-4 pt-8 border-t border-gray-200 mt-8">
              ...
              >
                ...
                <span v-if="processing">Creating Professional...</span>
...
const submit = () => {
  form.post('/admin/tax-professionals')
}
</script>